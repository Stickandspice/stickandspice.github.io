...
const products = [
    { id: 1, name: 'Allspice', category: 'jars', image: 'https://images2.imgbox.com/27/a2/4BaXIm5g_o.jpeg', price: 5.99, description: 'Warm allspice in a handcrafted jar' },
    { id: 2, name: 'Basil', category: 'jars', image: 'https://images2.imgbox.com/fe/d6/sT8QS6bJ_o.jpeg', price: 5.99, description: 'Fresh dried basil in a handcrafted jar' },
    { id: 3, name: 'Bay Leaves', category: 'jars', image: 'https://images2.imgbox.com/ae/80/xh0RRtFB_o.jpeg', price: 5.99, description: 'Premium bay leaves in a handcrafted jar' },
    ...
    { id: 6, name: 'Cardamom', category: 'jars', image: 'https://images2.imgbox.com/03/ee/SY6Jh916_o.jpeg', price: 5.99, description: 'Exotic cardamom in a handcrafted jar' },
    ...
    { id: 8, name: 'Celery Salt', category: 'jars', image: 'https://images2.imgbox.com/78/f9/p395zkUC_o.jpeg', price: 5.99, description: 'Celery salt in a handcrafted jar' },
    ...
    { id: 11, name: 'Cinnamon', category: 'jars', image: 'https://images2.imgbox.com/fb/4a/MgZJJOXp_o.jpeg', price: 5.99, description: 'Sweet cinnamon in a handcrafted jar' },
    { id: 12, name: 'Cloves', category: 'jars', image: 'https://images2.imgbox.com/f2/be/STYct0EN_o.jpeg', price: 5.99, description: 'Aromatic cloves in a handcrafted jar' },
    { id: 13, name: 'Coriander', category: 'jars', image: 'https://images2.imgbox.com/52/1e/TPUds9zl_o.jpeg', price: 5.99, description: 'Fragrant coriander in a handcrafted jar' },
    ...
    { id: 22, name: 'Garlic Powder', category: 'jars', image: 'https://images2.imgbox.com/88/70/4zuZcPwZ_o.jpeg', price: 5.99, description: 'Aromatic garlic powder in a handcrafted jar' },
    { id: 23, name: 'Garlic Salt', category: 'jars', image: 'https://images2.imgbox.com/a8/42/XLKkN4wv_o.jpeg', price: 5.99, description: 'Savory garlic salt in a handcrafted jar' },
    ...
    { id: 26, name: 'Himalayan Pink Salt', category: 'jars', image: 'https://images2.imgbox.com/46/06/IzF9Cbv3_o.jpeg', price: 5.99, description: 'Premium Himalayan pink salt in a handcrafted jar' },
    { id: 27, name: 'Italian Seasoning', category: 'jars', image: 'https://images2.imgbox.com/42/e7/zGEFewMU_o.jpeg', price: 5.99, description: 'Italian seasoning blend in a handcrafted jar' },
    ...
    { id: 32, name: 'Onion Powder', category: 'jars', image: 'https://images2.imgbox.com/95/02/2ZFRh4XP_o.jpeg', price: 5.99, description: 'Flavorful onion powder in a handcrafted jar' },
    { id: 33, name: 'Onion Salt', category: 'jars', image: 'https://images2.imgbox.com/23/62/vwAUQP42_o.jpeg', price: 5.99, description: 'Savory onion salt in a handcrafted jar' },
    { id: 34, name: 'Oregano', category: 'jars', image: 'https://images2.imgbox.com/39/aa/iaYbVXZK_o.jpeg', price: 5.99, description: 'Fresh oregano in a handcrafted jar' },
    { id: 35, name: 'Paprika', category: 'jars', image: 'https://images2.imgbox.com/3f/16/tFZcjYPB_o.jpeg', price: 5.99, description: 'Vibrant paprika in a handcrafted jar' },
    { id: 36, name: 'Parsley', category: 'jars', image: 'https://images2.imgbox.com/b8/cb/hBcj7Ewo_o.jpeg', price: 5.99, description: 'Fresh parsley in a handcrafted jar' },
    { id: 37, name: 'Pepper', category: 'jars', image: 'https://images2.imgbox.com/c0/f9/noHh5ZBC_o.jpeg', price: 5.99, description: 'Fresh ground pepper in a handcrafted jar' },
    ...
    { id: 41, name: 'Rosemary', category: 'jars', image: 'https://images2.imgbox.com/4f/34/dpekP91x_o.jpeg', price: 5.99, description: 'Fresh rosemary in a handcrafted jar' },
    ...
    { id: 43, name: 'Sage', category: 'jars', image: 'https://images2.imgbox.com/ed/74/ztfabNVw_o.jpeg', price: 5.99, description: 'Earthy sage in a handcrafted jar' },
    { id: 44, name: 'Salt', category: 'jars', image: 'https://images2.imgbox.com/39/74/KBzYW4VS_o.jpeg', price: 5.99, description: 'Premium salt in a handcrafted jar' },
    { id: 45, name: 'Season Salt', category: 'jars', image: 'https://images2.imgbox.com/0f/0f/shCM9yVo_o.jpeg', price: 5.99, description: 'Seasoned salt blend in a handcrafted jar' },
    ...
    { id: 48, name: 'Star Anise', category: 'jars', image: 'https://images2.imgbox.com/8e/70/NyuC0HWr_o.jpeg', price: 5.99, description: 'Exotic star anise in a handcrafted jar' },
    ...
    { id: 50, name: 'Tarragon', category: 'jars', image: 'https://images2.imgbox.com/46/6d/Qe2xRVTr_o.jpeg', price: 5.99, description: 'Aromatic tarragon in a handcrafted jar' },
    { id: 51, name: 'Thyme', category: 'jars', image: 'https://images2.imgbox.com/80/36/01xgZWu1_o.jpeg', price: 5.99, description: 'Fresh thyme in a handcrafted jar' },
    ...
    { id: 55, name: 'Aromatics Bundle', category: 'bundles', image: 'https://images2.imgbox.com/a1/6c/1sUwDAfb_o.jpeg', price: 17.99, description: 'Perfect aromatics bundle with essential spices' },
    { id: 56, name: 'Salt & Pepper Duo', category: 'bundles', image: 'https://images2.imgbox.com/01/f7/0bWRfJJw_o.jpeg', price: 10.99, description: 'Classic salt and pepper duo set' },
    { id: 57, name: 'Herb Bundle 1', category: 'bundles', image: 'https://images2.imgbox.com/35/ee/9zvbUFeH_o.jpeg', price: 17.99, description: 'Essential herbs bundle for everyday cooking' },
    { id: 58, name: 'Herb Bundle 2', category: 'bundles', image: 'https://images2.imgbox.com/33/5b/JCt1brI7_o.jpeg', price: 13.99, description: 'Premium herbs collection for gourmet dishes' },
    { id: 59, name: 'Herb Bundle 3', category: 'bundles', image: 'https://images2.imgbox.com/a5/5b/ZKPdVga5_o.jpeg', price: 13.99, description: 'Complete herb assortment for all your recipes' },
    { id: 60, name: 'Basic Herb Bundle', category: 'bundles', image: 'https://images2.imgbox.com/3f/2a/tBlo5elF_o.jpeg', price: 17.99, description: 'Starter herb bundle with kitchen essentials' },
    { id: 61, name: 'Core Pair Bundle', category: 'bundles', image: 'https://images2.imgbox.com/b5/9f/QlQn8O7T_o.jpeg', price: 10.99, description: 'Essential core spices duo' },
    { id: 62, name: 'Salt Bundle 1', category: 'bundles', image: 'https://images2.imgbox.com/2c/c7/yHx3xNt4_o.jpeg', price: 13.99, description: 'Premium salt collection variety pack' },
    { id: 63, name: 'Salt Bundle 2', category: 'bundles', image: 'https://images2.imgbox.com/d6/53/AM0nilfd_o.jpeg', price: 13.99, description: 'Gourmet salt assortment bundle' },
    { id: 64, name: 'All Jars Bundle - Complete Collection', category: 'bundles', image: 'https://images2.imgbox.com/8f/29/vQYLMiHO_o.png', price: 259.00, description: 'Get ALL 56 premium spice jars in one incredible collection! Every spice you need, beautifully handcrafted and ready to transform your kitchen.' }
];
